...
van uw mond.</li>
      <li className='font-sans text-xl text-[#A2D1DC]'>We hebben een rustige, respectvolle en goed georganiseerde omgeving gecreëerd
waarin elke patiënt zich ondersteund voelt door een ervaren en zorgzaam team.</li>
      <li className='font-sans text-xl text-[#A2D1DC]'>✔ Zorg voor het hele gezin — voor alle leeftijden</li>
      <li className='font-sans text-xl text-[#A2D1DC]'>✔Een rustige, professionele en moderne omgeving</li>
      <li className='font-sans text-xl text-[#A2D1DC]'>✔Een ervaren team ,toegewijd aan correcte en duurzame
behandelingen</li>
...
<div className='sm:w-1/2 hidden w-full sm:flex sm:justify-center sm:items-center'><img className='w-full object-cover h-full' src={welcome} alt='tooth'></img></div>
                ...
                <div className='w-full sm:h-[700px] h-[500px] bg-cover bg-center sm:bg-cover sm:bg-center bg-[url("assets/photos/clinicBg.jpg")] relative'>
                   ...
                   <div className='sm:w-1/2 w-full flex flex-col gap-3 p-5 font-sans text-lg'>
                            <h1 className='font-sans font-bold sm:text-2xl  uppercase'>Over de TANDIS-ervaring</h1>
                    ...
                    <div className='sm:w-1/2 w-full sm:flex sm:flex-col sm:gap-5 sm:p-5 flex flex-col gap-5 p-5'>
                      <div>
                        <h1 className='uppercase text-white sm:text-2x text-2xl mb-3 sm:mb-1 font-sans font-bold'>Bij TANDIS begint schoonheid met de juiste zorg</h1>
                        {/* <p className='text-white font-sans'>At Ben's Aesthetic, we continually challenge the status quo, finding new ways to improve our treatment plans, promote oral health and elevate the world of dentistry.</p> */}
                      </div>
                       <div>
                        <h1 className='uppercase text-[#A2D1DC] sm:text-2xl font-sans font-bold'>Eerst gezondheid, daarna esthetiek</h1>
                        <p className='text-white font-sans'>Met nauwkeurige restauraties, digitale diagnostiek en hoogwaardige behandelingen bouwen we eerst aan een gezonde basis — daarna creëren we een mooie glimlach.</p>
                      </div>
                       <div>
                        <h1 className='uppercase text-[#A2D1DC] sm:text-2xl font-sans font-bold'>Een gevoel van vertrouwen.</h1>
                        <p className='text-white font-sans'>We leggen elke stap helder uit. Niets blijft onduidelijk.
Samen bespreken we de mogelijkheden en nemen we beslissingen in overleg.</p>
                      </div>
                       <div>
                        <h1 className='uppercase text-[#A2D1DC] sm:text-2xl font-sans font-bold'>Natuurlijke en duurzame resultaten.</h1>
                        <p className='text-white font-sans'>Onze focus ligt op echte schoonheid: een glimlach die past bij jouw gezicht, gezond blijft en de natuurlijke tanden respecteert.</p>
                      </div>
                       <div>
                        <h1 className='uppercase text-[#A2D1DC] sm:text-2xl font-sans font-bold'>begeleiding tijdens het hele traject.</h1>
                        <p className='text-white font-sans'>De behandeling is niet het einde — het is het begin van blijvende zorg en opvolging.</p>
                      </div>
