  ...
  return (
    <Layout>
        ...
        <div className='absolute w-full h-full flex flex-col justify-center items-center p-5 text-start gap-5 sm:w-1/3'>
            ...
            <h1 className='w-full text-white text-2xl font-bold'>De combinatie van technologie en vakmanschap</h1>
            <p className='w-full text-white font-sans text-lg'>We werken met digitale scanners, nauwkeurige beeldvorming en moderne diagnostische tools.
...
Juist deze combinatie maakt het resultaat zo precies en betrouwbaar.</p>
                    ...
                    <section className='w-full sm:p-10 sm:flex sm:flex-col sm:justify-start sm:items-start sm:gap-5 sm:mt-2 flex flex-col gap-10 p-10 justify-center items-center'>
                            <h1 className='sm:w-full font-bold uppercase text-xl'>Diagnose vóór elke ingreep</h1>
                            <p className='sm:w-[60%] font-sans t'>Cosmetic dentistry is the business of smiles—after all, a brilliant smile is priceless. At the helm of this transformative field is Ben's Aesthetic, Dr. Behnam's visionary practice delivering the world’s most coveted and customized smiles.</p>
                            <p className='sm:w-[60%] font-sans '>In TANDIS nemen we de tijd om een volledig beeld van je mond te krijgen voordat we iets doen.
...
Zorg zonder overbehandeling.</p>
            ...
            <div className='sm:w-1/2 sm:flex sm:flex-col sm:items-start sm:justify-center sm:gap-5 sm:p-8 w-full flex flex-col justify-center items-start gap-8 p-8'>
                <h1 className='text-white sm:text-xl uppercase font-bold sm:w-full w-1/2 text-2xl'>Vertaling naar het Nederlands
Een glimlach herstellen begint bij harmonie — van tandstand
tot mondgezondheid.</h1>
                <p className='font-sans text-white sm:text-lg'>Bij TANDIS ontstaat een betere glimlach door twee elementen te combineren:
...
en soms kan een kleine restauratie de functie al sterk verbeteren.</p>
                <p className='font-sans text-white sm:text-lg'>Wij kiezen alleen behandelingen die jouw mond écht gezonder maken en de werking ervan verbeteren.
Een glimlach die goed functioneert, ziet er vanzelf goed uit.</p>
    ...
    <div className='sm:w-1/2 sm:h-[600px]  w-full h-[400px] sm:p-5'>
            ...
            <div className='sm:w-full sm:h-full bg-[url("assets/photos/laboratory1.jpg")] sm:bg-center sm:bg-cover w-full h-full bg-center bg-cover'></div>
                    ...
                    <h1 className='font-sans font-bold sm:text-2xl text-xl text-white sm:text-center uppercase'>TANDIS Praktijk</h1>
                    <p className='text-white sm:text-lg  text-center font-sans sm:text-center'>TANDIS let op de details die je ogen niet zien, maar waar je glimlach van afhankelijk is.</p>
